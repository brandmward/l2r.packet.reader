        ...
        public override IL2RPacket GetPacket(ushort PacketID, IL2RPacket packet)
        {
            try
            {
                switch (PacketID)
                {
                    ...
                    case 204: // 0xCB
                        {
                            return new PacketSightEnterNotify((L2RPacket)packet);
                        }
                        
                    case 203: // 0xCA
                    case 206: // 0xCD
                        {
                            return new PacketStatusMovement((L2RPacket)packet);
                        }
                        
                    case 289: // 0x120
                        {
                            return new PacketExpDisplayNotify((L2RPacket)packet);
                        }
                    ...
                    case 779: // 0x30C
                        {
                            //return new PacketChatGuildMessageReadResult";
                            return new PacketChatGuildWriteResult((L2RPacket)packet);     
                        }
                        
                    case 1401: // 0x57A
                        {
                            return new PacketClanInfoReadResult((L2RPacket)packet);
                        }
                        
                    case 1403: // 0x57B
                        {
                            return new PacketClanMemberListReadResult((L2RPacket)packet);
                        }
            ...
            {
                throw; // let exceptions bubble up to the service to handle...
